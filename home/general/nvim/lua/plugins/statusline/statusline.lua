...
E.mode = function()
  ...
  return "%#" .. E.modes[m][2] .. "#" .. "  " .. E.modes[m][1] .. " "
end
...
E.cursor_position = function()
  return vim.o.columns > 140 and "%#StText# Ln %l, Col %c  " or ""
end

E.file_encoding = function()
